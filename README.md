...
* [Deploy with auto-generated tag and Type ID](#deploy-with-auto-generated-tag-and-type-id)
* [Deploy with specific tag for version tracking](#deploy-with-specific-tag-for-version-tracking)
* [Upgrade existing contract to new version](#upgrade-existing-contract-to-new-version)
* [Usage](#usage)
* [Commands](#commands)
<!-- tocstop -->
...
<!-- commands -->
* [`ccc-deploy deploy generic_contract CONTRACTPATH`](#ccc-deploy-deploy-generic_contract-contractpath)
...
_See code: [src/commands/deploy/generic_contract.ts](https://github.com/pausable-udt/ccc-deploy/blob/v0.0.1-0/src/commands/deploy/generic_contract.ts)_
...
_See code: [src/commands/deploy/pausable_udt_script.ts](https://github.com/pausable-udt/ccc-deploy/blob/v0.0.1-0/src/commands/deploy/pausable_udt_script.ts)_
